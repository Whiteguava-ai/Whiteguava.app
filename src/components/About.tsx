      ...
      <div className="container">
        ...
        <div className={styles.bottomGrid}>
          <CardContainer containerClassName="reveal reveal-delay-2">
            <CardBody className={styles.statsCard}>
              <CardItem translateZ={20} className={styles.statsLeft}>
              ...
              <CardItem translateZ={45} className={styles.bigStat}>5+</CardItem>
            </CardBody>
          </CardContainer>

          <CardContainer containerClassName="reveal reveal-delay-3">
