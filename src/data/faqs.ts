export const homepageFaqs = [
  ...
  },
  {
    ...
    a: 'Yes. We build WhatsApp AI chatbots and agents on the WhatsApp Business API. They can handle customer queries, access your product or service data, process requests, and escalate to human agents when needed.',
  },
  {
...
export const aboutFaqs = [
  ...
  },
  {
    ...
    a: 'We move through six stages: understanding your business and the problem worth solving, designing the product and AI approach, building the application and integrations, connecting it to your existing tools and data, testing and deploying to production, and then continuing to improve it after launch.',
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Several of our projects touch internal documents, customer data, or proprietary workflows, so we're happy to sign an NDA before any detailed scoping conversation.",
  },
  {
    q: 'Can you work alongside our existing developers, or only end-to-end?',
    a: "Both. Some clients want us to own a project fully; others want us integrating AI or automation into a stack their own team maintains. We design around your existing systems rather than asking you to replace them.",
  },
  {
