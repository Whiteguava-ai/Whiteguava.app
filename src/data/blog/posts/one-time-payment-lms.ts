...
export const oneTimePaymentLms: BlogPost = {
  ...
  metaTitle: 'Self-Hosted LMS You Own: GuavaLearn (Docebo & TalentLMS Alternative)',
  metaDescription:
    'A self-hosted LMS and TalentLMS alternative you own: GuavaLearn runs courses, assessments and certifications on your own cloud for unlimited learners, AI built in. See the 5-year cost vs Docebo.',
  excerpt:
  ...
  tags: [
    ...
    'Docebo alternative self-hosted',
    'LMS you own',
    'LMS unlimited learners',
    'LMS without per-learner pricing',
    'one-time payment LMS',
    'corporate LMS no per user cost',
  ],
  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ['GuavaLearn (self-hosted)', 'flat server', '~$400', 'Built in (~$3–5/mo usage)', 'N/A'],
    ...
    {
      type: 'p',
      text: 'GuavaLearn is one of ten applications in the [Guava Product Suite](/guava), the same buy-once, own-it model applied to [HR and employee records](/blog/one-time-payment-hr-software), [customer support and knowledge base](/blog/one-time-payment-helpdesk) and [sales and pipeline](/blog/one-time-payment-crm).',
    },
