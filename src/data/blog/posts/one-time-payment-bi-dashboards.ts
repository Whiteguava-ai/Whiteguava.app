...
export const oneTimePaymentBi: BlogPost = {
  ...
  metaTitle: 'Self-Hosted Power BI Alternative You Own: GuavaInsights',
  metaDescription:
    'A self-hosted Power BI alternative you own: GuavaInsights runs dashboards, SQL and alerts on your own cloud with unlimited viewers, AI analyst built in. See the 5-year cost vs Tableau and Looker.',
  excerpt:
  ...
  tags: [
    ...
    'Tableau alternative self-hosted',
    'Looker alternative',
    'BI tool you own',
    'self-hosted dashboard tool',
    'one-time payment BI',
    'BI without per-seat pricing',
  ],
  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ['GuavaInsights (self-hosted)', 'N/A', '~$470', 'Built in (~$3–5/mo usage)', 'N/A'],
        ...
        ['ThoughtSpot (est.)', 'N/A', '~$30,000', 'Yes', '64×'],
        ['Looker (est.)', 'N/A', '~$60,000', 'Partial', '128×'],
      ],
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'GuavaInsights is one of ten applications in the [Guava Product Suite](/guava), the same buy-once, own-it model applied to [accounting and operations](/blog/one-time-payment-erp), [sales and pipeline](/blog/one-time-payment-crm) and [project work](/blog/one-time-payment-project-management).',
    },
