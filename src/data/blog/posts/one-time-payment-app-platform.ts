...
export const oneTimePaymentAppPlatform: BlogPost = {
  ...
  metaTitle: 'Self-Hosted Low-Code Platform You Own: GuavaFramework (Retool Alternative)',
  metaDescription:
    'A self-hosted low-code platform and Retool alternative you own: GuavaFramework runs on your own cloud with unlimited builders and users, AI built in. See the 5-year cost vs OutSystems and Mendix.',
  excerpt:
  ...
  tags: [
    ...
    'Retool alternative self-hosted',
    'Budibase alternative',
    'OutSystems alternative',
    'Mendix alternative',
    'low-code platform you own',
  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ['GuavaFramework (self-hosted)', 'flat server', '~$430', 'Built in (~$3–5/mo usage)', 'N/A'],
    ...
    {
      type: 'p',
      text: 'GuavaFramework is the platform the rest of the [Guava Product Suite](/guava) is built on, including [GuavaCRM](/blog/one-time-payment-crm), [GuavaERP](/blog/one-time-payment-erp) and [GuavaHR](/blog/one-time-payment-hr-software). Own the platform and you can build alongside them.',
    },
