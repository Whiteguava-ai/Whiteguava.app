...
export const oneTimePaymentErp: BlogPost = {
  ...
  metaTitle: 'Self-Hosted ERP & Odoo Alternative You Own: GuavaERP',
  metaDescription:
    'A self-hosted ERP and Odoo alternative you own: GuavaERP runs accounting, inventory and manufacturing on your own cloud, bought once, AI built in. See the 5-year cost vs NetSuite and SAP.',
  excerpt:
  ...
  tags: [
    'self-hosted ERP',
    'Odoo alternative',
    'NetSuite alternative self-hosted',
  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ['GuavaERP (self-hosted)', 'N/A', '~$650', 'Built in (~$3–5/mo usage)', 'N/A'],
        ...
        ['NetSuite · 10-user core (est.)', 'N/A', '~$30,000', 'Add-on', '46×'],
      ],
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'GuavaERP is one of ten applications in the [Guava Product Suite](/guava), the same buy-once, own-it model applied to [sales and pipeline](/blog/one-time-payment-crm), [HR and payroll](/blog/one-time-payment-hr-software) and [dashboards and reporting](/blog/one-time-payment-bi-dashboards).',
    },
