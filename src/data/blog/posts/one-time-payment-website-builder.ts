...
export const oneTimePaymentBuilder: BlogPost = {
  ...
  metaTitle: 'Self-Hosted Website Builder & Framer Alternative You Own: GuavaBuilder',
  metaDescription:
    'A self-hosted website builder and Framer alternative you own: GuavaBuilder gives you a visual canvas, CMS and unlimited sites on your own cloud, with the exported code. See the 5-year cost vs Webflow.',
  excerpt:
  ...
  tags: [
    ...
    'Framer alternative',
    'Webflow alternative self-hosted',
  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ['GuavaBuilder (self-hosted)', 'flat server, unlimited sites', '~$280', 'Built in (~$3–5/mo usage)', 'N/A'],
    ...
    {
      type: 'p',
      text: 'GuavaBuilder is one of ten applications in the [Guava Product Suite](/guava), the same buy-once, own-it model applied to [CRM and lead capture](/blog/one-time-payment-crm), [a helpdesk and knowledge base](/blog/one-time-payment-helpdesk) and [the low-code platform underneath](/blog/one-time-payment-app-platform).',
    },
